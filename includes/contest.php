<?php
	...
	$problemsQuery = "SELECT * FROM problems WHERE pyear='$uyear'";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
	 <a class="navbar-brand" href="#"><img src="../assets/images/SharedScreenshot.jpg" width="220" height="70" ></a>
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="../includes/home.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
...
<table class="table" style="color:white; width:60%; text-align: center; margin-left: 100px">
